import { Body, Column, Container, Head, Hr, Html, Img, Link, Preview, Row, Section, Text, render } from "@react-email/components";
...
const ReceiptEmail = ({date, email, orderId, products}: ReceiptEmailProps) => {
