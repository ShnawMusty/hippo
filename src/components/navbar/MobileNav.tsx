  ...
  return (
    <div className="z-[9999]">
      ...
      <div className='fixed overflow-y-scroll overscroll-y-none inset-0 z-40 flex'>
        <div className='w-4/5'>
          <div className='relative flex w-full max-w-md flex-col overflow-y-auto bg-white pb-12 shadow-xl'>
            ...
            <div className='flex justify-between items-center border-t border-gray-200 px-4 py-6'>
